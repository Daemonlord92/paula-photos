class PhotoBlogsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @photo_blog.save
        ...
        format.json { render :show, status: :created, location: @photo_blog }
      else
  ...
  def update
    respond_to do |format|
      if @photo_blog.update(photo_blog_params)
        ...
        format.json { render :show, status: :ok, location: @photo_blog }
      else
  ...
  def destroy
    @photo_blog.destroy
    respond_to do |format|
      format.html { redirect_to photo_blogs_url, notice: 'Photo blog was successfully destroyed.' }
  ...
  private
    ...
    def photo_blog_params
      params.require(:photo_blog).permit(:title, :description, :main_image)
    end
end
